...
from mp_sportsipy.constants import AWAY, WIN
from mp_sportsipy.nba.boxscore import Boxscore
from mp_sportsipy.nba.constants import SCHEDULE_URL
from mp_sportsipy.nba.schedule import Schedule
